...
| R | Release close-out (v0.4.0) | Done, merged | Claude | Merged `main` into the v0.4 line (PR #28's version/architecture fix; `APP_VERSION` conflict resolved to `0.4.0`), updated `CHANGELOG.md` (v0.3.0 + v0.4.0 entries), `docs/ROADMAP.md` (v0.4 → Completed, next v0.5), `docs/ARCHITECTURE.md` (planner layer, stale OCR note), `README.md` header/overview; fixed a flaky Tk-test isolation issue. PR #39 (merge commit). Released to `main` via PR #16 (`5b24233`), which closed Issue #15. |
